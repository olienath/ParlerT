 ...
 * This file demonstrates how to integrate Parlertts with a web frontend
 */

// For React/Vue/Angular applications
export class ParlerttsClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ParlerttsClient(provider, contractAddress);
